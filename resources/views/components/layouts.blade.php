...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Baloo+2&family=Megrim&display=swap" rel="stylesheet"> 
    <link rel="preconnect" href="https://fonts.gstatic.com">
...
<body>
    <div id="layouts">
        <main class="bg-white">
            <x-_navbar />
            <button onclick="topFunction()" id="BtnUp" title="Scroll Up"><i class="fas fa-level-up-alt"></i></button>
            {{$slot}}
            <x-_footer />
        </main>
    </div>
...
//Scroll up funzione javascript
button = document.getElementById("BtnUp");
